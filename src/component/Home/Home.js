    ...
    return(
      <div>
        <div className='wall-paper-top'>
          ...
          <div className='wall-paper-top-title'> 
            APEX Building Mainteance. Inc
          </div>
          <div className='wall-paper-top-body'>With a single phone call,</div>
          <div className='wall-paper-top-body'>virtually all your maintenance needs can be handled </div>
          <div className='wall-paper-top-body'>with a professional approach and personalize service.</div>
          <div className='wall-paper-top-tail'>CALL US TODAY  I  714.956.5032</div>
          <div className='wall-paper-top-click'>REQUEST A FREE QUOTE NOW</div>
          <div className=''></div>
        </div>
